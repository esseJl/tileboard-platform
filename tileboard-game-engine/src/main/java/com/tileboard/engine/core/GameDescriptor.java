...
public record GameDescriptor(
    ...
    public static final class Builder {
        ...
        public Builder boardSize(int w, int h)           { this.requiredWidth = w; this.requiredHeight = h; return this; }
        public Builder players(int min, int max)         { this.minPlayers = min; this.maxPlayers = max; return this; }
